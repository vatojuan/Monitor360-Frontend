...
<style scoped>
/* VARIABLES LOCALES (Mismo estilo que ManageDeviceView) */
.discovery-layout {
  --bg-color: #121212;
  --panel: #1b1b1b;
  --input-bg: #0e0e0e;
  ...
  --error-red: #d9534f;
  --gray: #9aa0a6;
  --border: #2a2a2a; /* Borde sutil del ManageDeviceView */
...
/* ESTILOS DE INPUT Y SELECT - COPIADO DE ManageDeviceView */
.form-group input,
.form-group select {
  width: 100%;
  padding: 10px;
