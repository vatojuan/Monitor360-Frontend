...
<style scoped>
/* ESTILO CORREGIDO: Variables globales + Fallback para selects */
...
/* Inputs & Selects - ARREGLADO CON IMPORTANT PARA EVITAR GRIS */
input,
select {
  width: 100%;
  /* Fallback a #121212 si la variable no carga */
  ...
  /* Reset de estilos nativos que causan el fondo gris */
...
/* Opciones del select */
select option {
  background-color: #121212 !important; /* Fallback manual */
  color: white;
}
...
.mini-select {
  ...
  font-size: 0.85rem;
  border-radius: 4px;
  /* Importante para el deslizador en la tabla */
  background-color: var(--bg-color, #121212) !important;
  border: 1px solid var(--primary-color);
  color: white;
}
